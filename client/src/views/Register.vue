...
<template>
  ...
  >
    <div
      class="tw:pointer-events-none tw:absolute tw:-left-24 tw:top-10 tw:h-72 tw:w-72 tw:rounded-full tw:bg-emerald-400/30 tw:blur-[120px]"
    ></div>
    <div
      class="tw:pointer-events-none tw:absolute tw:bottom-0 tw:right-0 tw:h-96 tw:w-96 tw:rounded-full tw:bg-orange-400/20 tw:blur-[130px]"
    ></div>
      ...
      >
        ...
        <div class="tw:mt-5 tw:space-y-5">
          ...
          <label for="password" class="tw:block">
            ...
            <div class="tw:mt-3 tw:space-y-2">
              <div class="tw:h-1.5 tw:w-full tw:overflow-hidden tw:rounded-full tw:bg-slate-800">
                <div
        ...
        <label for="agree" class="tw:mt-6 tw:flex tw:items-start tw:gap-3 tw:text-sm tw:text-slate-300">
          <input
            ...
            v-bind="agreeAttrs"
            type="checkbox"
            class="tw:mt-1 tw:h-4 tw:w-4 tw:rounded tw:border-slate-600 tw:bg-slate-900"
          />
          <span>
            I agree to the team guidelines and
            <router-link class="tw:text-emerald-300 hover:tw:text-emerald-200" to="/policy">
              data policy
            </router-link>
            for this workspace.
          </span>
        ...
        <prime-button
          ...
          :class="[
            canSubmit && !isSubmitting
              ? 'tw:bg-emerald-500 tw:text-slate-950 tw:shadow-lg tw:shadow-emerald-500/30 hover:tw:bg-emerald-400'
        ...
        <div class="tw:mt-6 tw:flex tw:items-center tw:justify-between tw:text-sm">
          <span class="tw:text-slate-400">Already have access?</span>
